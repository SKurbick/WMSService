...
> **Статус: HISTORICAL.** Это аудит сохранённого DDL на дату составления.
> Актуальные подтверждённые риски ведутся в [`known_issues.md`](../../current/known_issues.md); runtime-сверка 2026-08-08 описана в [`production_schema_audit_2026-08-08.md`](../../database/production_schema_audit_2026-08-08.md).

Источник: анализ `docs/archive/snapshots/wms_schema.sql`.
