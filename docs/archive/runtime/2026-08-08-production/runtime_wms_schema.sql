...
\restrict CB6VDakfcJPS5Ho3QKAqeihefjGF2NiwJDra9iB8hKTgCmUNkXQevV7Ypnx2PgX
...
CREATE TABLE wms.fbs_shipments (
    ...
    CONSTRAINT chk_fbs_shipments_source CHECK (((source)::text = ANY ((ARRAY['standard'::character varying, 'external_detected'::character varying, 'http_api'::character varying])::text[]))),
...
COMMENT ON COLUMN wms.movements.movement_type IS 'receive, putaway, transfer, pick, ship, unpack, adjust, kit_assembly, kit_disassembly, re_sorting.';
...
COMMENT ON COLUMN wms.movements.source_type IS 'Тип доменной операции-источника movement. Для пересортицы: re_sorting_operation; для комплектации: kit_operation.';
...
COMMENT ON COLUMN wms.movements.source_id IS 'ID доменной операции-источника. Для source_type=re_sorting_operation это wms.re_sorting_operations.operation_id.';
...
COMMENT ON COLUMN wms.movements.source_item_id IS 'ID строки детализации доменной операции. Для source_type=re_sorting_operation это wms.re_sorting_operation_items.item_id.';
...
CREATE TABLE wms.operation_locations (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_operation_locations_operation_code CHECK (((operation_code)::text = ANY ((ARRAY['kit_operations'::character varying, 're_sorting_operations'::character varying])::text[]))),
...
COMMENT ON TABLE wms.operation_locations IS 'Список WMS-локаций, на которых разрешены доменные операции. Поддерживаемые operation_code: kit_operations, re_sorting_operations.';
...
COMMENT ON COLUMN wms.operation_locations.operation_code IS 'Код доменной операции: kit_operations или re_sorting_operations.';
...
--
-- Name: re_sorting_operation_items; Type: TABLE; Schema: wms; Owner: -
--
...
CREATE TABLE wms.re_sorting_operation_items (
    ...
    movement_created_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_re_sorting_operation_item_quantity CHECK ((quantity > 0)),
    CONSTRAINT chk_re_sorting_operation_item_role CHECK (((role)::text = ANY ((ARRAY['source_outgoing'::character varying, 'target_incoming'::character varying])::text[])))
);


--
-- Name: TABLE re_sorting_operation_items; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON TABLE wms.re_sorting_operation_items IS 'Детализация пересортицы. У completed operation должно быть две строки: source_outgoing и target_incoming с одинаковым quantity.';


--
-- Name: COLUMN re_sorting_operation_items.role; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operation_items.role IS 'source_outgoing = списание from_product_id; target_incoming = приход to_product_id.';


--
-- Name: COLUMN re_sorting_operation_items.movement_id; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operation_items.movement_id IS 'ID movement, созданного для строки. FK не задаётся, поскольку partitioned wms.movements не имеет устойчивой parent PK/unique модели.';


--
-- Name: COLUMN re_sorting_operation_items.movement_created_at; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operation_items.movement_created_at IS 'created_at соответствующего movement; используется вместе с movement_id для поиска нужной partitioned movement row.';


--
-- Name: re_sorting_operation_items_item_id_seq; Type: SEQUENCE; Schema: wms; Owner: -
--

ALTER TABLE wms.re_sorting_operation_items ALTER COLUMN item_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME wms.re_sorting_operation_items_item_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: re_sorting_operations; Type: TABLE; Schema: wms; Owner: -
--
...
CREATE TABLE wms.re_sorting_operations (
    ...
    completed_at timestamp with time zone,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_re_sorting_operation_author CHECK ((btrim((author)::text) <> ''::text)),
    CONSTRAINT chk_re_sorting_operation_products_different CHECK (((from_product_id)::text <> (to_product_id)::text)),
    CONSTRAINT chk_re_sorting_operation_quantity CHECK ((quantity > 0)),
    CONSTRAINT chk_re_sorting_operation_reason CHECK ((btrim(reason) <> ''::text)),
    CONSTRAINT chk_re_sorting_operation_status CHECK (((status)::text = ANY ((ARRAY['processing'::character varying, 'completed'::character varying, 'failed'::character varying])::text[])))
);


--
-- Name: TABLE re_sorting_operations; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON TABLE wms.re_sorting_operations IS 'Атомарные WMS-операции пересортицы: одинаковое целое количество физического loose-остатка переносится между двумя разными product_id на одной разрешённой direct-локации. 1С и RabbitMQ не вызываются.';


--
-- Name: COLUMN re_sorting_operations.operation_location_id; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.operation_location_id IS 'Ссылка на активную allow-list строку wms.operation_locations с operation_code=re_sorting_operations и scope=direct.';


--
-- Name: COLUMN re_sorting_operations.from_product_id; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.from_product_id IS 'Исходный SKU/product_id, physical loose-остаток которого уменьшается.';


--
-- Name: COLUMN re_sorting_operations.to_product_id; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.to_product_id IS 'Целевой SKU/product_id, physical loose-остаток которого увеличивается.';


--
-- Name: COLUMN re_sorting_operations.quantity; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.quantity IS 'Целое положительное количество. Одинаково для исходящего и входящего movement.';


--
-- Name: COLUMN re_sorting_operations.location_id; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.location_id IS 'Точная direct-локация операции; subtree дочерних адресов не используется.';


--
-- Name: COLUMN re_sorting_operations.location_code; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.location_code IS 'Кешированный код использованной локации для аудита. Источник истины — location_id.';


--
-- Name: COLUMN re_sorting_operations.status; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.re_sorting_operations.status IS 'processing, completed, failed. В MVP business validation/conflict обычно откатывает transaction и не сохраняет failed operation, аналогично kit flow.';


--
-- Name: re_sorting_operations_operation_id_seq; Type: SEQUENCE; Schema: wms; Owner: -
--

ALTER TABLE wms.re_sorting_operations ALTER COLUMN operation_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME wms.re_sorting_operations_operation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE wms.receipt_items (
    ...
    update_document_datetime timestamp with time zone,
    event_status character varying(100),
    author_of_the_change character varying(255),
    our_organizations_name character varying(500),
    order_guid character varying(255),
...
--
-- Name: COLUMN receipt_items.document_created_at; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.document_created_at IS 'Дата создания документа поступления в 1С';


--
-- Name: COLUMN receipt_items.supply_date; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.supply_date IS 'Фактическая дата поступления товара из входного документа 1С';


--
-- Name: COLUMN receipt_items.update_document_datetime; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.update_document_datetime IS 'Дата и время последнего изменения документа в 1С';


--
-- Name: COLUMN receipt_items.event_status; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.event_status IS 'Статус документа поступления, полученный из 1С';


--
-- Name: COLUMN receipt_items.author_of_the_change; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.author_of_the_change IS 'Автор последнего изменения документа в 1С';


--
-- Name: COLUMN receipt_items.our_organizations_name; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.our_organizations_name IS 'Наименование нашей организации из документа 1С';


--
-- Name: COLUMN receipt_items.order_guid; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.order_guid IS 'GUID связанного заказа из документа 1С';


--
-- Name: COLUMN receipt_items.currency; Type: COMMENT; Schema: wms; Owner: -
--

COMMENT ON COLUMN wms.receipt_items.currency IS 'Валюта документа поступления';
...
--
-- Name: re_sorting_operation_items re_sorting_operation_items_pkey; Type: CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operation_items
    ADD CONSTRAINT re_sorting_operation_items_pkey PRIMARY KEY (item_id);


--
-- Name: re_sorting_operations re_sorting_operations_pkey; Type: CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operations
    ADD CONSTRAINT re_sorting_operations_pkey PRIMARY KEY (operation_id);
...
--
-- Name: re_sorting_operation_items uq_re_sorting_operation_item_role; Type: CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operation_items
    ADD CONSTRAINT uq_re_sorting_operation_item_role UNIQUE (operation_id, role);
...
--
-- Name: idx_re_sorting_operation_items_movement; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operation_items_movement ON wms.re_sorting_operation_items USING btree (movement_id) WHERE (movement_id IS NOT NULL);


--
-- Name: idx_re_sorting_operation_items_operation; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operation_items_operation ON wms.re_sorting_operation_items USING btree (operation_id);


--
-- Name: idx_re_sorting_operation_items_product; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operation_items_product ON wms.re_sorting_operation_items USING btree (product_id);


--
-- Name: idx_re_sorting_operations_created_at; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_created_at ON wms.re_sorting_operations USING btree (created_at DESC);


--
-- Name: idx_re_sorting_operations_from_product; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_from_product ON wms.re_sorting_operations USING btree (from_product_id);


--
-- Name: idx_re_sorting_operations_location; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_location ON wms.re_sorting_operations USING btree (location_id);


--
-- Name: idx_re_sorting_operations_operation_location; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_operation_location ON wms.re_sorting_operations USING btree (operation_location_id);


--
-- Name: idx_re_sorting_operations_status_created_at; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_status_created_at ON wms.re_sorting_operations USING btree (status, created_at DESC);


--
-- Name: idx_re_sorting_operations_to_product; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_re_sorting_operations_to_product ON wms.re_sorting_operations USING btree (to_product_id);
...
--
-- Name: idx_receipt_items_supply_date; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_receipt_items_supply_date ON wms.receipt_items USING btree (supply_date DESC) WHERE (supply_date IS NOT NULL);


--
-- Name: idx_receipt_items_update_document_datetime; Type: INDEX; Schema: wms; Owner: -
--

CREATE INDEX idx_receipt_items_update_document_datetime ON wms.receipt_items USING btree (update_document_datetime DESC) WHERE (update_document_datetime IS NOT NULL);
...
--
-- Name: re_sorting_operations trg_re_sorting_operations_updated_at; Type: TRIGGER; Schema: wms; Owner: -
--

CREATE TRIGGER trg_re_sorting_operations_updated_at BEFORE UPDATE ON wms.re_sorting_operations FOR EACH ROW EXECUTE FUNCTION wms.update_updated_at_column();
...
--
-- Name: re_sorting_operations fk_re_sorting_operation_from_product; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operations
    ADD CONSTRAINT fk_re_sorting_operation_from_product FOREIGN KEY (from_product_id) REFERENCES public.products(id) ON DELETE RESTRICT;


--
-- Name: re_sorting_operation_items fk_re_sorting_operation_item_operation; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operation_items
    ADD CONSTRAINT fk_re_sorting_operation_item_operation FOREIGN KEY (operation_id) REFERENCES wms.re_sorting_operations(operation_id) ON DELETE CASCADE;


--
-- Name: re_sorting_operation_items fk_re_sorting_operation_item_product; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operation_items
    ADD CONSTRAINT fk_re_sorting_operation_item_product FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE RESTRICT;


--
-- Name: re_sorting_operations fk_re_sorting_operation_location; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operations
    ADD CONSTRAINT fk_re_sorting_operation_location FOREIGN KEY (location_id) REFERENCES wms.locations(location_id) ON DELETE RESTRICT;


--
-- Name: re_sorting_operations fk_re_sorting_operation_operation_location; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operations
    ADD CONSTRAINT fk_re_sorting_operation_operation_location FOREIGN KEY (operation_location_id) REFERENCES wms.operation_locations(operation_location_id) ON DELETE RESTRICT;


--
-- Name: re_sorting_operations fk_re_sorting_operation_to_product; Type: FK CONSTRAINT; Schema: wms; Owner: -
--

ALTER TABLE ONLY wms.re_sorting_operations
    ADD CONSTRAINT fk_re_sorting_operation_to_product FOREIGN KEY (to_product_id) REFERENCES public.products(id) ON DELETE RESTRICT;
...
\unrestrict CB6VDakfcJPS5Ho3QKAqeihefjGF2NiwJDra9iB8hKTgCmUNkXQevV7Ypnx2PgX
