...
Источник правил: `wms_schema.sql`, `database_functions.md`, `database_triggers.md`, `invariants.md`, `known_issues.md`.
...
- Новый task write endpoint должен обновлять `docs/context/api_map.md` и `docs/context/business_rules.md`.
...
- обновлять `docs/context/api_map.md`;
- обновлять `docs/context/business_rules.md`;
- при новых DB rules/constraints добавлять миграцию и обновлять `docs/context/invariants.md`.
